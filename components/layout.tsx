    ...
    <div>
      ...
      <div className="fixed top-0 flex items-center justify-center w-full max-w-lg px-5 py-4 text-lg font-medium text-gray-700 bg-white border-b">
        {canGoBack ? (
          <button
            onClick={onClick}
            className="absolute left-5 hover:text-orange-500"
          >
            <svg
              className="w-6 h-6"
              fill="none"
      ...
      {hasTabBar ? (
        <nav className="fixed bottom-0 flex items-center justify-between w-full max-w-lg pt-2 pb-2 text-gray-800 bg-white border-t">
          <Link href="/">
            <a
              className={cls(
